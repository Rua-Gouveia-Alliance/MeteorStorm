...
; este ha_tecla nem faz sentido o que ta ali feito em baixo mas acho que o espera_tecla funciona
; ta com aspeto diferente mas so vai testar sempre a linha 4 a mesma
...
ha_tecla:              ; neste ciclo espera-se até NENHUMA tecla estar premida
	...
	loop_ha:
		DIV R1, R6     ; shift right
		CMP R1, 0      ; verificar se estamos a testar uma linha valida
		JZ tecla_ha    ; reinicializar o valor da linha e recomecar o ciclo caso linha seja invalida
		MOVB [R2], R1  ; escrever no periférico de saída (linhas)
		MOVB R0, [R3]  ; ler do periférico de entrada (colunas)
		AND  R0, R5    ; elimina bits para além dos bits 0-3
		CMP  R0, 0     ; há tecla premida?
		JNZ  loop_ha   ; se ainda houver uma tecla premida, espera até não haver
